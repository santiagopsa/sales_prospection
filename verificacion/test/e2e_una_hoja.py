...
CASO = r"""() => {
  ...
  S.reqs = [
    {rid:null, n:'Experiencia administrando infraestructura de redes LAN/WAN y equipos como switches, routers, access points y firewalls', lvl:4, ev:'',
     ...
     brecha:'Sin embargo, la WAN la manejaba Bogotá y su rol era de primer nivel; no detalló VLAN, reglas de firewall ni equipos concretos, que la pregunta pedía.',
    ...
    {rid:null, n:'Experiencia gestionando proveedores, contratos y acuerdos de nivel de servicio (SLA)', lvl:4, ev:'',
     ...
     brecha:'Lo que no llegó a mostrar fueron los umbrales numéricos ni las penalidades del SLA que el criterio esperaba.',
     falta:'', r:{}},
    {rid:null, n:'Gestión de presupuesto e infraestructura física con control en Excel/Google Sheets avanzado', lvl:4, ev:'',
     ...
     brecha:'Sin embargo, el control del presupuesto estaba a cargo de su jefe: sin cifras, funciones avanzadas de Excel ni una optimización cuantificada.',
...
with sync_playwright() as pw:
    ...
    for papel in ("Letter", "Legal"):
        ...
        for debe in ["backup4G", "Saurón", "OPEXdeCAPEX", "Nagios", "JerónimoMartins", "PeakUrespondeporesteinforme", "Recomendación:", "Escala1-5", "Sinembargo"]:
